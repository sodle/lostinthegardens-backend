function Privacy() {
  return (
    <div style={{ textAlign: "left" }}>
      <h1>Lost in the Gardens Privacy Policy</h1>
      <p>
        This privacy policy applies to the{" "}
        <strong>Lost in the Gardens app</strong> (hereby referred to as{" "}
        <strong>"Application"</strong>) for mobile devices, which was created by{" "}
        <strong>Scott Odle</strong> (hereby referred to as{" "}
        <strong>"Service Provider"</strong>) as an Open Source service. This
      ...
      <p>
        ...
        of your mobile device. Your location is determined while using the
        Application, in order to provide navigation functionality, but this
        information is not transmitted from your device.
      </p>
      <h2>
      ...
      <p>
        ...
        Service Provider (privacy@lostinthegardens.com) so that they will be
      ...
      <p>This privacy policy is effective as of September 5, 2025.</p>
      <h2>Your Consent</h2>
      <p>
      ...
      <p>
        ...
        Provider via email at privacy@lostinthegardens.com.
      </p>
      <hr />
      <p>
